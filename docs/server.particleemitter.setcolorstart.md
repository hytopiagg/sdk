...
[Home](./index.md) &gt; [server](./server.md) &gt; [ParticleEmitter](./server.particleemitter.md) &gt; [setColorStart](./server.particleemitter.setcolorstart.md)

## ParticleEmitter.setColorStart() method
