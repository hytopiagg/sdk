...
[Home](./index.md) &gt; [server](./server.md) &gt; [ParticleEmitter](./server.particleemitter.md) &gt; [setColorEndVariance](./server.particleemitter.setcolorendvariance.md)

## ParticleEmitter.setColorEndVariance() method
